...
指令：file helloCTFer
執行結果：helloCTFer_CPP: ELF 32-bit LSB executable, Intel 80386, version 1 (SYSV), dynamically linked, interpreter /lib/ld-linux.so.2, for GNU/Linux 2.6.32, BuildID[sha1]=12a295d9f244896d6393fb167fcf2b969404aba2, not stripped
```
```
指令：
